...
#import our recaptcha keys. You should go into local_settings.py and put your
#keys in so you're not using the same example keys as everyone else who
#downloads this library
from local_settings import RECAPTCHA_PRIVATE_KEY, RECAPTCHA_PUBLIC_KEY

#add .. to the path so we can pick up recaptcha_comments
...
SECRET_KEY = 'nsregu#pvy!_6t%g9999^g=dtbn0d1kzy0zgk&m1ekgy!d0x$p'
